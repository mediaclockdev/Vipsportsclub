...
const WhyAussLoveUs = () => {
  ...
  return (
    <div className="bg-linear-to-br from-[#1D3A36] via-[#1A2B32] to-[#131E24]">
      <div className="max-w-screen-2xl mx-auto px-8 py-5 space-y-15">
        <div className="flex justify-center">
          <h2 className="text-[36px]">Why Aussies Love Us</h2>
        </div>
          ...
          {globe.map((item, id) => (
            <div key={id} className="flex flex-col items-center gap-4">
              ...
              <div className="flex flex-col items-center gap-4">
                <p className="max-w-[500px] lg:max-w-[255px] text-center  text-base">
                  {item.title}
                </p>
              </div>
            </div>
